...
function CreateTableItems(data, key, bool = true) {
  var values = {
      "Login": ['name', 'uri', 'username', 'password'],
      "Card": ['name', 'number', 'term', 'cvv'],
      "Note": ['name', 'title', 'text']
  };
  var headers = {
      "Login": ['Cartella', 'URI', 'Username', 'Password'],
...
window.onload = function() {
  /*
  Causa richiesta asincrona, si attende quando la richiesta è completata per poter eseguire il click del bottone
  per poter visualizzare gli elementi nella cartella di default e per poter aggiungere gli eventi ai bottoni di eliminazione
  */
